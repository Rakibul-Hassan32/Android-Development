package com.brainstormer.tictactoe;
...
int flag = 0, count = 0;
    ...
    //show output corresponding with input
    public void check(View view){

        //button class's object to work with buttons
        Button btnCurrent = (Button) view;

        //if button is empty only then we can input something
        ...
        if(count>4){
            ...
            //conditions for winning decider
